    ...
    <div class="container">
      <div class="tm-search-form-container" style="background-color:RGB(150,52,125)">
        <form  method="POST" class="form-inline">
            ...
            <div style="background-color:#cc41ff;border-radius:10px; padding:15px;"  class="text-center col-12 col-md-3 ">
            <div style="width: 100%;height:80px;">
            <h3 class="text-center" style="color:#fff; padding:20px;font-weight:bolder">Video<h3>
            </div>
            </div>
            <div style="background-color:transparent;" class="text-center col-12 col-md-9"  >
            <input name="search" class="form-inline form-control float-sm-left float-left"  type="text" style="padding:5px; width:70%; background-color:#fff;margin: 10px; ">
            <button type="submit" name="aud-btn" style="margin-top: 10px;background-color:#cc41ff;border:none;float:left" class="btn btn-primary form-inline float-sm-left float-left" >
            Search</button>
          </div>
            </form>
          </div>
       <?php
          if(isset($_POST['selectthis']) && isset($_POST['fromthis'])){
              ...
              echo "<br><div class='col-12 col-md-12'><h4 class='text-uppercase'>Video<i class='fa fa-angle-double-right'></i>".$selectthis."<i class='fa fa-angle-double-right'></i>".$fromthis."</h4></div><br>";
              }
      ?>
...
<!-- video  -->
        ...
        <?php
            if(isset($_POST['selectthis']) && isset($_POST['fromthis'])){
              ...
              $selectthis=$_POST['selectthis'];
              $fromthis=$_POST['fromthis'];
              $query="SELECT * FROM `video_music` WHERE `$selectthis` = '$fromthis'";
        ...
        <div class="col-sm-12 col-12 col-md-6 col-lg-3 col-xl-3 tm-album-col">
          <figure class="effect-sadie">
            ...
            <?php
              ...
              $query="SELECT * FROM video_music WHERE `name` LIKE '%$search%' OR `artist` LIKE '%$search%'  OR `album` LIKE '%$search%'  OR `genre` LIKE '%$search%'";
              $result=mysqli_query($conn,$query);
