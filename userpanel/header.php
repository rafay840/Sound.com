...
<a class="navbar-brand" style="margin-top: 5px;color:white;" href="#">
  ...
  <ul class="navbar-nav design">
      ...
      <div class="dropdown-menu  design" style="background-color:RGB(150,52,125);">
       <a class="dropdown-item " href="audio_index.php">Audio Song</a>
        
        <a class="dropdown-item " href="video_index.php">Video Song</a>
      </div>
    </li>
     <?php
    ...
    ?>
     ...
     <form method="POST" action="audio_index.php">
       <input type="hidden" name="selectthis" value="<?php echo $navname[0];?>">
        <input   class="navs dropdown-item text-uppercase" type="submit" name="fromthis" value="<?php echo $navname1[0];?>">
      </form>
      <?php 
